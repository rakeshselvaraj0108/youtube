        ...
        <ul className="flex flex-col">
          {report.breakdown.map((row) => {
            ...
            return (
              <li
                key={row.category}
                className="flex items-center gap-2.5 border-b border-edge/60 px-4 py-2 last:border-b-0"
              >
                <Icon className="h-3.5 w-3.5 shrink-0 text-inkFaint" strokeWidth={1.6} />
